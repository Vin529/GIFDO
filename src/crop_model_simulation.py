...
def simulate_annual_expected_yields(
    ...
    while not done and iter < 1_000_000:
        ...
        #so for every iteration before the end here, reward is just going to give me back some negative constant multiplied by whatever irrigation value i feed it in action
        #on the last iteration, it will give me self.cumulative_biomass * self.crop_harvest_index plus this negative irrigation reward
