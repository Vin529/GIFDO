...
#saves detailed data on top candidates and the population as a whole to the run summary directory every X generations, as well as creating some plots
SNAPSHOT_EVERY_X_GENERATIONS = 100
#pickles and saves a copy of the entire simulation state into the run summary directory every X generations
#this can be used to resume a simulation from a prior state, using the LOAD_FROM_CHECKPOINT parameter in main.py
